...
- [Data Management Plan template file](assets/docs/GenericDMPTemplatev5.docx)
...
- [Kanban boards](https://en.wikipedia.org/wiki/Kanban_board)
  - _Kanban is a flexible way to manage projects that allows for rearrangement and rescheduling in the middle of the work. It doesn't require any particular tool or software (I used to use sticky notes), but Trello and GitHub do a good job of this - LP_
